...
{
	wp_enqueue_style('bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap-v4-grid-only@1.0.0/dist/bootstrap-grid.min.css');
...
function js_theme()
{
	...
	wp_enqueue_script('main', get_template_directory_uri() . '/js/swiperApi.js', NULL, true);
...
// Свои изображения
add_image_size('thumbnail-size-home', 380, 380, true);

// Переименовать записи, можно созда
...
function rename_posts_labels($labels)
{
	...
	$new = array(
		...
		'not_found_in_trash'    => 'Недвижимость в корзине не найдено.',
		'parent_item_colon'     => '',
		'all_items'             => 'Вся Недвижимость',
		'archives'              => 'Архивы Недвижимости',
		'insert_into_item'      => 'Вставить в Недвижимость',
		'uploaded_to_this_item' => 'Загруженные для этой Недвижимости',
		'featured_image'        => 'Миниатюра Недвижимости',
		'filter_items_list'     => 'Фильтровать список Недвижимости',
		'items_list_navigation' => 'Навигация по списку Недвижимости',
		'items_list'            => 'Список Недвижимости',
		'menu_name'             => 'Недвижимость',
		'name_admin_bar'        => 'Недвижимость!', // пункте "добавить"
	);
...
if (function_exists('acf_add_options_page')) {
	...
	acf_add_options_page(array(
		...
		'menu_title'  => 'Общие настройки cайта',
...
// 	$labels->name               = 'Тип недвижимости';
// 	$labels->singular_name      = 'Тип недвижимости';
// 	$labels->add_new            = 'Add Тип недвижимости';
// 	$labels->add_new_item       = 'Add Тип недвижимости';
// 	$labels->edit_item          = 'Edit Тип недвижимости';
// 	$labels->new_item           = 'Тип недвижимости';
// 	$labels->view_item          = 'View Тип недвижимости';
// 	$labels->search_items       = 'Search Тип недвижимости';
// 	$labels->not_found          = 'No Тип недвижимости found';
// 	$labels->not_found_in_trash = 'No Тип недвижимости found in Trash';
// 	$labels->all_items          = 'All Тип недвижимости';
// 	$labels->menu_name          = 'Тип недвижимости';
// 	$labels->name_admin_bar     = 'Тип недвижимости'; 
